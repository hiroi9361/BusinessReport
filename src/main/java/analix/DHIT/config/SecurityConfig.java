...
//                .requestMatchers("/login").permitAll()
                ...
                .requestMatchers("/manager/create").hasAnyRole("ADMIN", "USER")
                .requestMatchers("/manager/employeeList").hasAnyRole("ADMIN", "USER")
                .requestMatchers("/manager/employeeList-edit").hasAnyRole("ADMIN", "USER")
